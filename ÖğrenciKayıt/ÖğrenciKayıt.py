...
class Pencere(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.resim = QtWidgets.QLabel(self)#resim oluşturma
        self.resim.setPixmap(QtGui.QPixmap("aa.png"))
     ...
     try:
      ...
      if self.gir.text() != "" and self.gir2.text() != ""and self.gir3.text() != "" and self.gir4.text() != "":
        ...
        self.yazı_alanı.move(130, 200)
         ...
         if self.gir.text() != "" and self.gir2.text() != "" and self.gir3.text() != "" and self.gir4.text() != "":
             cursor.execute("Insert into ogr Values(?,?,?,?)",
                            (self.gir.text(), self.gir2.text(), self.gir3.text(), self.gir4.text()))
             con.commit()
             self.yazı_alanı.setText("Kayıt Başarılı!...")
             self.yazı_alanı.move(150, 200)
             self.gir.clear()  # Yazıları silme
